    ...
    <DialogPortal>
      ...
      >
        ...
        <DialogPrimitive.Close
          aria-label="닫기"
          className="absolute right-4 top-4 rounded-sm text-text-2 opacity-70 transition-opacity hover:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none"
        >
