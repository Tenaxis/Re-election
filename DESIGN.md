...
> 향후 기능(참여 인증 등)은 [`docs/ROADMAP.md`](docs/ROADMAP.md)에서 관리한다.
...
> 향후 기능용 데이터 모델은 [`docs/ROADMAP.md`](docs/ROADMAP.md) 참조.

## B7. 로드맵

단계별 구현 계획(Phase 1~4)과 향후 기능은 [`docs/ROADMAP.md`](docs/ROADMAP.md)에서 관리한다.
현재 구현 대상은 **Phase 1 (MVP)**.
